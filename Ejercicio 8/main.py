import csv
from ClaseManejador import ManejadorEmpleados
    ...
    for fila in reader:
        if not bandera:
            ...
            if nomArchivo == 'planta.csv':
                ...
                manejador.crearEmpleadoExterno(fila[0], fila[1], fila[2], fila[3], fila[4], fila[5], fila[6], fila[7],
                                               fila[8], fila[9])
    archivo.close()
...
if __name__ == '__main__':
    ...
    miMenu.mostrarempleado('Usuario: {0}'.format(miLogin.getnivel().upper()))
